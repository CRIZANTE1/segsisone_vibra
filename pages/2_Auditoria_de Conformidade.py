...
# A verificação de permissão envolve toda a lógica da página
        ...
        if selected_company_id:
            ...
            if selected_doc:
                ...
                if norma_para_analise in nr_analyzer.nr_sheets_map:
                    ...
                    st.warning(f"A análise para a {norma_para_analise} não está disponível. Nenhuma planilha de RAG foi configurada para esta norma.")
